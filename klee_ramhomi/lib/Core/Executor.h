...
private:
  ...
  // Homi //////////////////////////////////////////////////////////////
  std::map<std::string, unsigned> read_feature(std::string dirname, std::string naming, bool flag, std::string iterIndex);
  std::vector<unsigned> read_pruningratio(std::string dirname, std::string naming, bool flag, std::string iterIndex);
  ...
  // For Seeding Pruning Algorithms
  ...
  void run(ExecutionState &initialState, std::string, std::string, std::string, bool, std::string);
...
public:
  ...
  void runFunctionAsMain(llvm::Function *f, int argc, char **argv,
                         char **envp, std::string, std::string, std::string, bool, std::string) override;
