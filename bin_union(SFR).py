...
if __name__=="__main__":
    ...
    for i, _ in enumerate(time_budget_handler):
        ...
        symtuner.add(pconfig, testcases_symtuner, parameters=parameters, evaluation_kwargs=evaluation_argument, rm_cmd=rm_cmd, flag="else")
    ...
    coverage, bugs = symtuner.get_coverage_and_bugs()
    get_logger().info(f'Union-based integration of SymTuner+FeatMaker+RAM achieved {len(coverage)} coverage.')