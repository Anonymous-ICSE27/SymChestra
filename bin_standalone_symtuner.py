...
if __name__=="__main__":
    ...
    # Symtuner Parser
    argparser.add_argument('-s', '--search-space', default='/root/symchestra/benchmarks/spaces.json', type=str, metavar='JSON',
    ...
    for i, max_time in enumerate(time_budget_handler):
    ...
    coverage, bugs = symtuner.get_coverage_and_bugs()
    get_logger().info(f'Standalone SymTuner achieved {len(coverage)} coverage.')